//
//  LocationSearchPopupViewController.m
//  Homeless Helper
//
...
@interface LocationSearchPopupViewController ()

@end

@implementation LocationSearchPopupViewController
...
{
    if ([self.placeType isEqualToString:@"Place"]) {
        [delegate setVenue:[self.placeArray objectAtIndex:[[self.searchResultsTableView indexPathForSelectedRow] row]]];
    } else if ([self.placeType isEqualToString:@"Address"]) {
        [delegate setAddress:[self.placeArray objectAtIndex:[[self.searchResultsTableView indexPathForSelectedRow] row]]];
    }
}
...
{
    [self.placeTypeSegmentedControl setFrame:CGRectMake(self.view.frame.size.width / 2 - 80, self.view.frame.origin.y + 5, 160, 30)];
    [self.searchBar setFrame:CGRectMake(self.view.frame.origin.x, self.placeTypeSegmentedControl.frame.origin.y + self.placeTypeSegmentedControl.frame.size.height + 5, self.view.frame.size.width, 43)];
    [self.mapView setFrame:CGRectMake(10, self.searchBar.frame.origin.y + self.searchBar.frame.size.height + 10, self.view.frame.size.width - 20, 100)];
    [self.searchResultsTableView setFrame:CGRectMake(self.view.frame.origin.x, self.mapView.frame.origin.y + self.mapView.frame.size.height + 10, self.view.frame.size.width, self.view.frame.size.height - (self.mapView.frame.origin.y + self.mapView.frame.size.height + 10))];
}
